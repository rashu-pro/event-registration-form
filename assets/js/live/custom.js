        ...
        <div class="form-row-foot">
            <div class="text-center">
                <a href="javascript:void(0)" class="btn btn-dark btn-add-another-js disabled">
                    <img src="/beta/Content/event-management-assets/individual-multiple-assets/images/plus_circle.png" class="img-left">
...
$('.btn-event-register').on('click', function () {
    ...
    if(formGroupRequired != formGroupValidated){
...
$(document).on('click', '.btn-add-another-js', function (e) {
    ...
    console.log('invalid field length:'+invalidField.length);
    console.log('valid field length:'+validField.length);
    if (invalidField.length === validField.length) {
        ...
        console.log('all field not validated');
        notValidatedField.first().find('.form-control').focus();
...
$('.radiobox.required-group input').on('change',function (e) {
    ...
    if(self.closest('.form-group.radiobox').hasClass('focused')){
        self.closest('.form-group.radiobox').removeClass('focused');
    }
});
